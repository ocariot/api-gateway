const policy = require('../../../../eg-plugin-ocariot/policies/authentication/jwt-policy')
const assert = require('chai').assert
const sinon = require('sinon')

describe('Policy: ocariot-jwt-policy', () => {

    describe('Integrity', () => {
        it('Field "name" is type valid', () => {
            assert.typeOf(policy.name, 'string', '"name" is not string type')
            assert.equal(policy.name, 'ocariot-jwt-policy', 'Policy name other than expected')
        })
        ...
        it('Field "schema.$id" is type valid', () => {
            ...
            assert.equal(policy.schema.$id, 'http://express-gateway.io/schemas/policies/ocariot-jwt-policy.json', '"schema.$id" different than expected')
        })
