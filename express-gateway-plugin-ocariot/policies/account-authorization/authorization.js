...
module.exports = function (actionParams) {
    return (req, res, next) => {
        ...
        if (/^(\/v1\/users\/)[^\W_]{24}\/{0,1}$/.test(req.path) && req.method === 'DELETE') {
        ...
        else if (/^((\/v1\/users\/)[^\W_]{24}\/password\/{0,1})$/.test(req.path) && req.method === 'PUT') {
        ...
        else if (/^((\/v1\/institutions\/)[^\W_]{24}\/{0,1})$/.test(req.path) && req.method === 'GET') {
        ...
        else if (/^((\/v1\/institutions\/)[^\W_]{24}\/{0,1})$/.test(req.path) && req.method === 'PATCH') {
        ...
        else if (/^((\/v1\/children\/)[^\W_]{24}\/{0,1})$/.test(req.path) && req.method === 'GET') {
        ...
        else if (/^((\/v1\/families\/)[^\W_]{24}\/{0,1})$/.test(req.path) && req.method === 'GET') {
            getFamilyByIdRules(req, res, next)
        }
        // PATCH /v1/families/{family_id} ['families:update']
        else if (/^((\/v1\/families\/)[^\W_]{24}\/{0,1})$/.test(req.path) && req.method === 'PATCH') {
            patchFamilyByIdRules(req, res, next)
        }
        // GET /v1/families/{family_id}/children ['families:read']
        else if (/^((\/v1\/families\/)[^\W_]{24}\/children)/.test(req.path) && req.method === 'GET') {
        ...
        else if (/^((\/v1\/educators\/)[^\W_]{24}\/{0,1})$/.test(req.path) && req.method === 'PATCH') {
        ...
        else if (/^((\/v1\/educators\/)[^\W_]{24}\/children\/groups)/.test(req.path) && req.method === 'GET') {
        ...
        else if (/^((\/v1\/healthprofessionals\/)[^\W_]{24}\/{0,1})$/.test(req.path) && req.method === 'GET') {
            getHealthProfByIdRules(req, res, next)
        }
        // PATCH /v1/healthprofessionals/{healthprofessional_id} ['healthprofessionals:read']
        else if (/^((\/v1\/healthprofessionals\/)[^\W_]{24}\/{0,1})$/.test(req.path) && req.method === 'PATCH') {
        ...
        else if (/^((\/v1\/healthprofessionals\/)[^\W_]{24}\/children\/groups)/.test(req.path) && req.method === 'GET') {
        ...
        else if (/^((\/v1\/applications\/)[^\W_]{24}\/{0,1})$/.test(req.path) && req.method === 'GET') {
...
function userUpdatePassRules(req, res, next) {
    if ((req.user.sub_type === UserType.ADMIN ||
        ...
        req.user.sub_type === UserType.HEALTH_PROFESSIONAL) && equalUserIds(req)) {
        next()
        return
    }
    errorHandler(403, res)
